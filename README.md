...
Ihr findet [hier](https://github.com/git-guides/install-git) die offizielle Installationsanleitungen für alle Betriebssysteme. Gebt Bescheid, wenn es Probleme gibt 😉
